export const faq_data = [
  ...
  {
    key: "3",
    questions: "Is the data stored in an Insight Talent Solution secure?",
    answers: "Yes, Insight Talent Solution is design with advanced security measures, including data encryption",
    category: "Feature",
  },
  {
    key: "4",
  ...
  {
    key: "5",
    questions: "How do I generate custom reports in the Insight Talent Solution?",
  ...
  {
    key: "7",
    questions: "How do I process payroll in the Insight Talent Solution?",
