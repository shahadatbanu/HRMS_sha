  ...
  // },
  {
    ...
    submenuItems: [
      ...
      },
      {
        ...
        base: 'leaves',
        icon: 'leaf', // Added icon for Leaves
        submenuItems: [
          {
            label: 'Leaves (Admin)',
            link: routes.leaveadmin,
      ...
      // },
       {
         ...
         submenuItems: [
          ...
          // {
          //   label: 'Top Active Candidates',
          //   link: routes.topActiveCandidates,
          //   submenu: false,
          //   showSubRoute: false,
          //   base: 'top-active-candidates',
          //   roles: ['admin', 'hr'],
          // },
          // {
          //   label: 'Dead/Low Candidates',
          //   link: routes.deadLowCandidates,
          //   submenu: false,
          //   showSubRoute: false,
          //   base: 'dead-low-candidates',
          //   roles: ['admin', 'hr'],
          // },
           {
             label: 'Activity Threshold Settings',
             link: routes.candidateActivityThreshold,
             submenu: false,
             showSubRoute: false,
             base: 'candidate-activity-threshold',
             roles: ['admin', 'hr'],
           },
         ],
       },
